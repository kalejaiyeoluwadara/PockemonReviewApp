    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PokemonId = table.Column<int>(type: "INTEGER", nullable: false),
                    OwnernerId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonOwners", x => new { x.PokemonId, x.OwnernerId });
                    table.ForeignKey(
                        name: "FK_PokemonOwners_Owners_OwnernerId",
                        column: x => x.OwnernerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonOwners_OwnernerId",
                table: "PokemonOwners",
                column: "OwnernerId");
